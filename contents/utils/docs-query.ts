    ...
    return [
        {
            ...
            'doc': `v1.2.1 Bugfixes release
Please have one look on the bug fixes releases.
v1.2.1 New Feature release
Please have one look on the new features!
# Markdown示例

本文件的源码是一个markdown文件,也就是说在本工程中直接添加markdown即可嵌入到sphinx文档中。

关于使sphinx支持markdown的详细配置说明，请参考文档[markdown-sphinx](markdown-sphinx)。
